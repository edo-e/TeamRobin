...
data_set_merged.to_csv('/Users/eduardo/TeamRobin/Total_origin_destination.csv')

data_set_merged_continent = data_set_merged.groupby(['Continent','Year'])[['Female','Male']].sum().reset_index()
data_set_merged_continent.to_csv('/Users/eduardo/TeamRobin/Total_continent.csv')


dataset_total_long_grouped_region = data_set_merged.groupby(['Region', 'Year'])[['Female','Male']].sum().reset_index()
dataset_total_long_grouped_region.to_csv('/Users/eduardo/TeamRobin/Total_region.csv')

dataset_total_long_grouped_destination = data_set_merged.groupby(['Destination', 'Year'])[['Female','Male']].sum().reset_index()
dataset_total_long_grouped_destination.to_csv('/Users/eduardo/TeamRobin/Total_destination.csv')

dataset_total_long_grouped_origin = data_set_merged.groupby(['Origin', 'Year'])[['Female','Male']].sum().reset_index()
